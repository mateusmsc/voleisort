...
export default function PromoteNextModal({ teamAPlayers, teamBPlayers, onConfirm, onCancel }) {
    ...
    <div className="fixed inset-0 bg-black/50 flex items-end justify-center z-50">
      <div className="bg-white dark:bg-stone-800 rounded-t-2xl w-full max-w-md p-5 pb-10">
        ...
        <p className="text-xs text-stone-400 text-center mb-5">
          Qual time sair de quadra? Ele vai para o final da fila sem derrota.
        </p>
